        ...
        <div className="card shadow-sm p-4 p-md-5">
          <div className="text-center mb-4">
            ...
            <p className="text-muted">
              Create your account to become a lifesaver.
            </p>
          </div>
          <form onSubmit={handleSubmit} className="row g-3">
            ...
            <div className="col-12">
              <label htmlFor="house_street" className="form-label">
            ...
            <div className="col-12">
              <label htmlFor="google_maps_link" className="form-label">
              ...
              <div className="form-text text-muted">
                If possible, please share a Google Maps link to your address.
              </div>
            </div>
            ...
            <div className="col-12 mt-4">
              <div className="form-check">
                ...
                <label className="form-check-label" htmlFor="agreed_to_terms">
                  I agree to the{' '}
                  <Link to="/terms" className="text-lifeline">
                    terms and conditions
                  </Link>{' '}
                  and confirm I am eligible to donate blood.
                </label>
              </div>
            </div>
            ...
            <div className="col-12 text-center mt-3">
              <p className="text-muted">
                ...
                <Link to="/login" className="text-lifeline">
                  Login
                </Link>
              </p>
            </div>
